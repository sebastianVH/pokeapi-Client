                    ...
                    <form onSubmit={handleSubmit} className={styles.form}>
                        ...
                        <div className={styles.row}>
                            ...
                            <div className={styles.formElements}>
                                ...
                                <input type="number" name="speed" className={errors.speed ? styles.error : styles.success} value={pokemondata.speed} onChange={handleChange} />
                        ...
                        <div className={styles.row}>
                            <div className={styles.formElements}>
                                ...
                                <input type="number" name="height" className={errors.height ? styles.error :styles.success} value={pokemondata.height} onChange={handleChange} />
                                <span className={styles.errorText}>{errors.height}</span>
                            </div>
                            <div className={styles.formElements}>
                                <label className={styles.inputLabel} htmlFor="weight">Weight</label>
                                <input type="number" name="weight" className={errors.weight ? styles.error :styles.success} value={pokemondata.weight} onChange={handleChange} />
